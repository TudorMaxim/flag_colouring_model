...
"}")
        ...
        self.menu_create = QtWidgets.QMenu(self.menu_file)
        ...
        self.action_add_student = QtWidgets.QAction(Simulator)
        self.action_add_student.setObjectName("action_add_student")
        self.action_add_teacher = QtWidgets.QAction(Simulator)
        self.action_add_teacher.setObjectName("action_add_teacher")
        self.action_add_course = QtWidgets.QAction(Simulator)
        self.action_add_course.setObjectName("action_add_course")
        self.create_dataset_action = QtWidgets.QAction(Simulator)
        self.create_dataset_action.setObjectName("create_dataset_action")
        self.create_timetable_action = QtWidgets.QAction(Simulator)
        self.create_timetable_action.setObjectName("create_timetable_action")
        self.menu_new.addAction(self.action_add_student)
        self.menu_new.addAction(self.action_add_teacher)
        self.menu_new.addAction(self.action_add_course)
        self.menu_create.addAction(self.create_dataset_action)
        self.menu_create.addAction(self.create_timetable_action)
        self.menu_file.addSeparator()
        self.menu_file.addAction(self.menu_new.menuAction())
        self.menu_file.addAction(self.menu_create.menuAction())
    ...
    def retranslateUi(self, Simulator):
        ...
        self.menu_new.setTitle(_translate("Simulator", "New"))
        self.menu_create.setTitle(_translate("Simulator", "Create"))
        ...
        self.action_add_student.setText(_translate("Simulator", "Student"))
        self.action_add_teacher.setText(_translate("Simulator", "Teacher"))
        self.action_add_course.setText(_translate("Simulator", "Course"))
        self.create_dataset_action.setText(_translate("Simulator", "Dataset"))
        self.create_timetable_action.setText(_translate("Simulator", "Timetable"))

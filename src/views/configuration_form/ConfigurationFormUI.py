...
"}")
        ...
        self.tool_box.setMinimumSize(QtCore.QSize(0, 245))
        self.tool_box.setMaximumSize(QtCore.QSize(16777215, 400))
        self.tool_box.setObjectName("tool_box")
        self.algorithm_page = QtWidgets.QWidget()
        self.algorithm_page.setGeometry(QtCore.QRect(0, 0, 1027, 150))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.algorithm_page.setMinimumSize(QtCore.QSize(0, 150))
        ...
        self.population_model_label = QtWidgets.QLabel(self.algorithm_page)
        self.population_model_label.setObjectName("population_model_label")
        self.main_form_layout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.population_model_label)
        self.population_model_combo_box = QtWidgets.QComboBox(self.algorithm_page)
        self.population_model_combo_box.setObjectName("population_model_combo_box")
        self.population_model_combo_box.addItem("")
        self.population_model_combo_box.addItem("")
        self.main_form_layout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.population_model_combo_box)
        self.selection_method_label = QtWidgets.QLabel(self.algorithm_page)
        self.selection_method_label.setObjectName("selection_method_label")
        self.main_form_layout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.selection_method_label)
        self.selection_method_combo_box = QtWidgets.QComboBox(self.algorithm_page)
        self.selection_method_combo_box.setObjectName("selection_method_combo_box")
        self.selection_method_combo_box.addItem("")
        self.selection_method_combo_box.addItem("")
        self.main_form_layout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.selection_method_combo_box)
        self.crossover_method_label = QtWidgets.QLabel(self.algorithm_page)
        self.crossover_method_label.setObjectName("crossover_method_label")
        self.main_form_layout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.crossover_method_label)
        self.crossover_method_combo_box = QtWidgets.QComboBox(self.algorithm_page)
        self.crossover_method_combo_box.setObjectName("crossover_method_combo_box")
        self.crossover_method_combo_box.addItem("")
        self.crossover_method_combo_box.addItem("")
        self.crossover_method_combo_box.addItem("")
        self.main_form_layout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.crossover_method_combo_box)
        ...
        self.penalties_page.setGeometry(QtCore.QRect(0, 0, 1027, 152))
    ...
    def retranslateUi(self, ConfigurationForm):
        ...
        self.population_model_label.setText(_translate("ConfigurationForm", "Population Model:"))
        self.population_model_combo_box.setItemText(0, _translate("ConfigurationForm", "Steady-State Population"))
        self.population_model_combo_box.setItemText(1, _translate("ConfigurationForm", "Generational Population"))
        self.selection_method_label.setText(_translate("ConfigurationForm", "Selection Method:"))
        self.selection_method_combo_box.setItemText(0, _translate("ConfigurationForm", "Roulette-Wheel Selection"))
        self.selection_method_combo_box.setItemText(1, _translate("ConfigurationForm", "Tournament Selection"))
        self.crossover_method_label.setText(_translate("ConfigurationForm", "Crossover Method:"))
        self.crossover_method_combo_box.setItemText(0, _translate("ConfigurationForm", "One-Point Crossover"))
        self.crossover_method_combo_box.setItemText(1, _translate("ConfigurationForm", "Two-Points Crossover"))
        self.crossover_method_combo_box.setItemText(2, _translate("ConfigurationForm", "Uniform Crossover"))
